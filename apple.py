...
def output_pdf(filename_prefix, source_url):
    ...
    updated_html_text = re.sub(r'(<link rel=\"stylesheet\" type=\"text/css\" href=\")(.+feedback.css)(\">)',
                         r'\1https://cdn.rawgit.com/xyzgentoo/printApplePG/master/feedback1.css\3', updated_html_text)
    ...
    output_pdf_name = filename_prefix + '_' + items[len(items) - 1] + '.pdf'
